<li class="form_edit_<?php echo $form_data['id']; ?>">
	<form action="index.php" method="post" name = "reply_form<?php echo $form_data['id']; ?>" enctype="multipart/form-data">
	<div>
		<p>
			<em>【編集】</em>
			<em>タイトル：</em>
		...
		<p>
			...
			<input name="parent_id" type="hidden" value="<?php echo $form_data['parent_id']; ?>">
			<input name="reply_id"  type="hidden" value="<?php echo $form_data['reply_id']; ?>">
		</p>
	</div>
	</form>
</li>
